! function() {
	...
	var e = {
			...
			set: function(r, t, e, o, n, i) {
				var a = String(encodeURIComponent(t)),
					h = e;
				try {
					o = o ? o : e.getDomain()
				} catch (s) {}
		...
		o = function() {
			function r(r) {
				if (external) try {
					var t = external.twGetRunPath.toLowerCase(),
						e = external.twGetSecurityID(window),
						o = external.twGetVersion(e);
			...
			return function() {
				function i() {
					var r = new Date,
						t = Date.parse("Jan 1," + r.getFullYear());
					return +r - t
				}
				...
				function h() {
					...
					var r, e = p.split("|").concat(l.split("|")),
						h = [];
				...
				var s, c, d, f = navigator.userAgent,
					u = ["windows", "mac", "android", "ipad", "iphone", "linux", "other"],
					...
					b = new RegExp(l, "i"),
					m = ["ucbrowser", "crios", "mqqbrowser", "sogoumobilebrowser", "oupeng", "chrome"],
					w = "other",
					_ = "other",
					x = "00";
				if (f.indexOf("Android") > -1 ? c = "Android" : (c = f.match(/(Windows|Mac|Android|ipad|iphone|linux)/i), c = c ? c[0] : "other"), (s = f.match(/MSIE ([^;]*)|Trident.*; rv(?:\\s|:)?([\d.]+)/)) && s[1] ? (_ = "ie", _ = "trident", x = e(s[1])) : (s = f.match(/Chrome\/([\d.]*)/)) && s[1] && (_ = "chrome", w = "chrome", x = s[1]), (s = f.match(b)) && s[0] && f.indexOf("Android") < 0 && f.indexOf("Mobile") < 0) {
					if (f.indexOf("AppleWebKit") > -1 && (_ = "webkit"), w = s[0].toLocaleLowerCase(), (d = w.match(/se\s(\d+)\./i)) && d[1]) w = "se [0-9]+.", x = d[1];
					else if (l.indexOf(w) > -1) {
				...
				if (f.indexOf("AppleWebKit") > -1)
					if (w = "webkit", _ = "webkit", (s = f.match(/OPR\/([\d.]*)/)) && s[1]) x = e(s[1]), w = "opera";
					else if ((s = f.match(/\/([\d.]*) Mobile/)) && s[1]) {
				...
				} else(s = f.match(/\/([\d.]*) Safari/)) && s[1] ? (w = "safari", x = e(s[1]), !/version\/([\d.]+).*safari/.test(f) && (s = f.match(/Chrome\/([0-9.]*)/)) && s[1] && (w = "chrome", x = s[1])) : (s = f.match(/Chrome\/([0-9.]*)/)) && s[1] && (w = "chrome", x = s[1]);
				else(s = f.match(/Gecko/)) ? (w = "Gecko", _ = "Gecko", (s = f.match(/Firefox\/([\d.]*)/)) && s[1] && (w = "firefox", x = e(s[1]))) : (s = f.match(/Presto\/([\d.]*)/)) && s[1] && (_ = "presto", x = e(s[1]), (s = f.match(/Opera\/([\d.]*)/)) && s[1] && (w = "opera", x = e(s[1]), (s = f.match(/Opera\/.* Version\/([\d.]*)/)) && s[1] && (x = e(s[1])), (s = f.match(/Opera Mini[^;]*/)) && s ? (w = "opera mini", x = s[0]) : (s = f.match(/Opera Mobi[^;]*/)) && s && (w = "opera mobi", x = s[0])));
				return h()
			}
		}(),
		n = new r;
...
! function(t, n) {
	if (!t.sufei) {
		...
		! function(n) {
			...
			function r(t, n, e) {
				c ? t.addEventListener(n, e) : t.attachEvent("on" + n, e)
			}
			...
			function o(t) {
				if (t) {
					...
					if (n) {
						var e = n[1];
						return v.test(e) && (e = e.split("@").pop().split(":")[0]), e
					}
				}
			}
			var c = !!t.addEventListener,
				a = 1e10 * Math.random() >>> 0;
			n.random = e, n.getTime = Date.now || function() {
				return +new Date
			}, n.eventBind = r;
			var u = /\.com\.cn$|\.com\.hk$/,
				f = /^(\d+\.){3}\d+$/;
		...
		! function(t) {
			...
			var c = 0,
				a = 0,
				u = "onwheel" in n.createElement("div") ? "wheel" : "onmousewheel" in n ? "mousewheel" : "DOMMouseScroll";
			i.eventBind(n, u, r), i.eventBind(n, "mousemove", e), i.eventBind(n, "touchmove", e), t.update = o
		}(o || (o = {}));
		var c;
		! function(e) {
			function r() {
			...
			var w = r(),
				_ = [i, o, c, a, u, g, g, f, s, g, g, v, d, h, l, p];
			e.getBitset = m
		}(c || (c = {}));
		var a, u = "l",
			f = "isg2",
		...
		! function(t) {
			function e(t) {
				var e = n.cookie,
					...
					i = e.indexOf(r);
				if (-1 == i) {
					if (r = t + "=", e.substr(0, r.length) != r) return;
					i = 0
				}
				var o = i + r.length,
					c = e.indexOf("; ", o);
				return -1 == c && (c = e.length), e.substring(o, c)
			}

			function r(t, e, r, i, o) {
				var c = t + "=" + e;
				i && (c += "; domain=" + i), o && (c += "; path=" + o), r && (c += "; expires=" + r), n.cookie = c
			}

			function i(t, n, e) {
				this.write(t, "", "Thu, 01 Jan 1970 00:00:00 GMT", n, e)
			}
			t.read = e, t.write = r, t.remove = i
		}(a || (a = {}));
		var v, d = function() {
			function t(t) {
				this._fields = t
			...
			return t.prototype.toBuffer = function() {
				for (var t = this._fields, n = [], e = -1, r = 0, i = t.length; i > r; r++)
					for (var o = this[r], c = t[r], a = e += c; n[a] = 255 & o, 0 != --c;) --a, o >>= 8;
				return n
		...
		! function(t) {
			...
			function i(t) {
				return e.encode(t).replace(/\+/g, "-").replace(/\=/g, "_")
			}

			function o(t) {
				return t = t.replace(/\-/g, "+").replace(/\_/g, "="), e.decode(t)
			}
		...
		! function(t) {
			function n() {
				...
				if (t && 32 == t.length) {
					var n = v.unpack(t);
					if (n && (h.decode(n), 0 != h[g])) return
				}
				h[g] = i.random()
			}

			function e() {
				h[l]++, h[w] = i.getTime() / 1e3 | 0;
				var t = o.update();
			...
			function f() {
				var t = 4,
					e = 2;
				h = new d([e, e, t, t, t, e, e, e]), n(), h[p] = 65535 & i.random(), h[l] = 0, h[m] = 0, h[_] = c.getBitset()
			}
		...
		! function(e) {
			function o(t, n, e) {
				...
				if (!r) return !1;
				var i = e(r);
				return A || (i._str = r + ""), i._raw = r, t[n] = i, !0
			}

			function c() {
				var t = h.update();
				a.write(u, t, "Fri, 01 Feb 2030 00:00:00 GMT", b, "/")
			}

			function v(t) {
				var n = i.getHostFromUrl(t);
				return n ? B.test(n) : !0
			}
			...
			function d() {
				function e(t) {
					...
					var r = !n || /^_self$/i.test(n);
					if (r) {
						var i = t.href.split("#")[0];
						if (i == _ && t.hash) return !1
					}
					return !0
				}
				var o = n.getElementsByTagName("base");
				i.eventBind(n, "click", function(t) {
					t = t || event;
				...
				}), i.eventBind(n, "submit", c), r || i.eventBind(t, "unload", c)
			}
					...
					if (n && "SCRIPT" == n.tagName) {
						...
						if (/callback=/.test(e)) {
							for (var r = 0; r < k.length; r++)
								if (k[r].test(e)) return;
							v(e) ? c() : n.src = t(n.src)
						}
					}
				}
				if (A) o(Element.prototype, "insertBefore", function(t) {
					return function(n) {
						try {
							e(n)
						} catch (r) {}
					...
					o(i, "insertBefore", r), o(n.body, "insertBefore", r)
				}
			}

			function w() {
				var n = t.sufei_jsonp_ignore;
				n instanceof Array && (k = k.concat(n)), _ = location.href.split("#")[0], y = location.hostname, b = i.getRootDomain(y), B = new RegExp("\\.?" + b.replace(/\./g, "\\.") + "$", "i"), d(), l(), m(), c()
			}
			var _, y, b, B, A = !!t.addEventListener,
				k = s;
			e.init = w
		}(l || (l = {}));
		try {
